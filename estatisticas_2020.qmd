# Estatísticas 2020 {#sec-dados-ouvidoria-2020}
...
## Tempo de atendimento {#sec-tempos-2020}
...
A [seção @sec-tempo-medio-2020] analisa os valores e evoluções do tempo médio de atendimento das demandas, enquanto a [seção @sec-tempo-medio-2020] repete as análises, porém utilizando a mediana como medida resumo dos dados.

O ano de 2020 trouxe índices de atendimento superiores devido ao represamento de cartas no período entre 2017 e 2019, com 
início de tratamento em 2020, especialmente, em janeiro onde se teve uma força tarefa para regularização das pendências.
...
### Médias dos tempos de atendimento {#sec-tempo-medio-2020}

Agora, a [figura @fig-evolucao-tempo-media-2020] mostra a evolução das médias mensais dos tempos de atendimento.

```{r}
#| label: fig-evolucao-tempo-media-2020
#| fig-cap: >
...
### Medianas dos tempos de atendimento {#sec-tempo-mediano-2020}

O gráfico na [figura @fig-evolucao-tempo-mediana-2020] repete a análise anterior, porém utilizando a mediana como índice de medição.

```{r}
#| label: fig-evolucao-tempo-mediana-2020
#| fig-cap: >
