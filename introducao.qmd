...
Este relatório contempla informações no período de referência, ou seja, entre 
`r min(vetor_filtro1)` e
`r max(vetor_filtro1)`.
Estruturalmente, está organizado em três áreas de atuação, sendo: projetos capitaneados pela Onasp; ações da Ouvidoria Nacional dos Serviços Penais; e tratamentos estatísticos das demandas de ouvidoria. 
